...
- Разбивай ответ на абзацы с помощью двойного переноса строки
- Используй **жирный текст** для важных моментов
- Используй маркированные списки (- пункт) для перечислений
- Используй нумерованные списки (1. пункт) для шагов
- Делай ответ структурированным и легко читаемым
